...
function gameOver(a) {
    var gameOverAlertElement = "<b>GAME OVER </b><br><br> Jucatorul " + span[a].dataset.player.toUpperCase() + ' A câștigat !!! <br><br>' + restartButton;
...
function draw() {
    var drawAlertElement = '<b>Egalitate !!!</b><br><br>' + restartButton;
    var div = document.createElement("div");
    div.className = "alert";
